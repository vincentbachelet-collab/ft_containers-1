...
namespace ft
{
    ...
    public:
        ...
        reverse_iterator(const reverse_iterator<iterator_type> &src) : _ptr(src._ptr) {}
        ...
        difference_type operator-(const reverse_iterator &rhs) const { return (this->_ptr + rhs._ptr); }
        difference_type operator+(const reverse_iterator &rhs) const { return (this->_ptr - rhs._ptr); }
